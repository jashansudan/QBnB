...
if(isset($_POST['deleteAcc']) && isset($_SESSION['member_id'])){
    ...
    $sql2 = "DELETE * FROM Rental_Properties WHERE member_id=$member_id";
                        ...
                        <form name='editProfile' id='editProfile' action='settings.php' method='post'>
                            <table border='0'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                        <input class = 'btn btn-primary temp' type='submit' name='updateBtn' id='updateBtn' value='Update' /> 
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <td> <center><input class = 'btn btn-primary temp'  type='submit' name='deleteAcc' id='deleteAcc' value='Delete Account'/>
                                 </center></td>
